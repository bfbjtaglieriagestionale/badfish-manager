const CACHE='badfish-manager-v61';
const SHELL=[
  './','./index.html','./styles-v61.css','./config.js?v=61','./boot-v61.js','./drive-v61.js','./app-v61.js',
  './manifest.webmanifest?v=61','./assets/badfish-logo.png?v=61','./assets/icon-192.png?v=61',
  './assets/icon-512.png','./assets/apple-touch-icon.png?v=61','./assets/favicon-32.png?v=61'
];
