const CACHE='badfish-manager-v63';
const SHELL=[
  './','./index.html','./styles-v63.css','./config.js?v=62','./boot-v62.js','./drive-v62.js','./app-v63.js',
  './manifest.webmanifest?v=63','./assets/badfish-logo.png?v=63','./assets/icon-192.png?v=63',
  './assets/icon-512.png','./assets/apple-touch-icon.png?v=63','./assets/favicon-32.png?v=63'
];
