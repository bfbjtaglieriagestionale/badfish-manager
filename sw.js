const CACHE='badfish-manager-v2-configured';
const ASSETS=['./','./index.html','./styles.css','./config.js','./drive.js','./app.js','./manifest.webmanifest','./assets/badfish-logo.png','./assets/icon-192.png','./assets/icon-512.png'];
